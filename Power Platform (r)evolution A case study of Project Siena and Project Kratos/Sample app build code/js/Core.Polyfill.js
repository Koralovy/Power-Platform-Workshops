    ...
    (function(Polyfill) {
        var ClickWatcher = function() {
                ...
                return ClickWatcher.prototype.notifyTouchStart = function(touchId, clientX, clientY) {
                        ...
                        }, ClickWatcher.prototype.executeTouchClick = function(touchId, clientX, clientY, callback) {
                            this._isTouchValid(touchId) && (this._registerClick(clientX, clientY, callback), callback())
                        }, ClickWatcher.prototype.executeMouseClick = function(clientX, clientY, callback) {
                            this._isValidClick(clientX, clientY, callback) && (this._registerClick(clientX, clientY, callback), callback())
        ...
        var ClickEventOverride = function() {
                ...
                return ClickEventOverride.prototype.getAddEventListenerOverrides = function(eventName, callback) {
                        ...
                        this._forEachChangedTouch(evt, function(touch) {
                            ...
                            var _this = this;
                            this._forEachChangedTouch(evt, function(touch) {
                                return _this._clickWatcher.executeTouchClick(touch.identifier, touch.clientX, touch.clientY, callback.bind(callback, evt))
                            })
                        }, ClickEventOverride.prototype._onElementClick = function(callback, evt) {
                            this._clickWatcher.executeMouseClick(evt.clientX, evt.clientY, callback.bind(callback, evt))
